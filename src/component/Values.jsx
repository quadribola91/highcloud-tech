              ...
              <div className="space-y-6 mb-8">
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    satisfaction by adhering to industry best practices and
                    proven technology standards.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our mission is to empower businesses with scalable and
                    secure IT solutions that improve efficiency, productivity,
                    and competitiveness.
                  </p>
                </div>
              </div>
