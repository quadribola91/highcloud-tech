          ...
          <ScrollReveal once>
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Highcloud Technologies provides reliable and forward-thinking IT
                solutions that align with your business priorities for growth,
                innovation, and operational excellence. We minimize disruptions
                by ensuring availability, performance, and timely execution
                across all IT services.
              </p>

              <p className="text-gray-600 leading-relaxed mb-8">
                Our team operates with precision and accountability, delivering
                solutions within agreed timelines while maintaining high
