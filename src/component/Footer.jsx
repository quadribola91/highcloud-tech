...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-gray-900 text-gray-300 pt-16 pb-8 opacity-0 translate-y-10 transition-all duration-700"
    >
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        {/* Brand */}
        <div>
          <h2 className="text-xl font-bold text-white mb-4">Highcloud Tech</h2>
      ...
      <div className="border-t border-gray-800 mt-12 pt-6 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} Highcloud Tech. All rights reserved.
      </div>
    </footer>
  );
}
